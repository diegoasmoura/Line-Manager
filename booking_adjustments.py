                ...
                if not split_adjustments.empty:
                    for _, split_adj in split_adjustments.iterrows():
                        split_record = {
                            ...
                            "Port of Loading POL": adjusted_data["s_port_of_loading_pol"],
                            "Port of Delivery POD": adjusted_data["s_port_of_delivery_pod"], 
...
def format_column_name(col_name):
    ...
    column_map = {
        ...
        "Port of Loading POL": "Porto de Origem (POL)",
        "Port of Delivery POD": "Porto de Destino (POD)",
