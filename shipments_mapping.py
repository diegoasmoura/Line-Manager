...
def get_column_mapping():
    return {
        ...
        "b_document_cut_off_doccut": "Document Cut Off DOCCUT",
        "b_port_cut_off_portcut": "Port Cut Off PORTCUT",
        "b_estimated_time_of_departure_etd": "Estimated Time Of Departure ETD",
        "b_estimated_time_of_arrival_eta": "Estimated Time Of Arrival ETA",
...
def drop_downs(data_show, df_udc):
    ...
    column_editors = {
        ...
        "Document Cut Off DOCCUT": "date",
        "Port Cut Off PORTCUT": "date",
