...
def non_editable_columns(stage):
    ...
    if stage == "Sales Data":
        ...
        non_editable = ["Booking Farol Reference", "Creation Of Booking", "Adjusts Basic", "Adjusts Critic"]
    elif stage == "Container Delivery at Port":
        non_editable = ["Loading Farol Reference", "Creation Of Cargo Loading", "Adjusts Basic", "Adjusts Critic"]
    else:
        non_editable = []
