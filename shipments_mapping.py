...
def get_column_mapping():
    return {
        ...
        "s_requested_deadlines_start_date":"Requested Deadline Start Date",
        "s_requested_deadlines_end_date":"Requested Deadline End Date",
        "s_dthc_prepaid": "DTHC",
        "s_afloat": "Afloat",
        ...
        "b_data_partida_atd": "Data Partida ATD",
        "b_data_estimada_transbordo_etd": "Data Estimada Transbordo ETD",
        "b_data_chegada_ata": "Data Chegada ATA",
        "b_data_transbordo_atd": "Data Transbordo ATD",
        "b_data_estimativa_atracacao_etb": "Data Estimativa Atracação ETB",
        "b_data_atracacao_atb": "Data Atracação ATB",
...
def drop_downs(data_show, df_udc):
    ...
    column_editors = {
        ...
        "Requested Deadline Start Date": "date",
        "Requested Deadline End Date": "date",
        "Shipment Period Start Date": "date",
        "Shipment Period End Date": "date",
        "Required Arrival Date Expected": "date",
        "LC Received": "date",
        ...
        "Data Confirmação Embarque": "datetime",
        "Data Partida ATD": "datetime",
        "Data Estimada Transbordo ETD": "datetime",
        "Data Chegada ATA": "datetime",
        "Data Transbordo ATD": "datetime",
